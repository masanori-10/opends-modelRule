...
public class SteeringCar extends Car 
{
	...
	private float minLateralSafetyDistanceBase;
	private float minForwardSafetyDistanceBase;
	private float emergencyBrakeDistanceBase;
	...
	private float emergencyContext = 1.0f;
	private float safetyContext = 1.0f;
	...
	{		
		...
		// minLateralSafetyDistanceBase =
		// scenarioLoader.getCarProperty(CarProperty.cruiseControl_safetyDistance_lateral,
		// SimulationDefaults.cruiseControl_safetyDistance_lateral);
		...
		// minForwardSafetyDistanceBase =
		// scenarioLoader.getCarProperty(CarProperty.cruiseControl_safetyDistance_forward,
		// SimulationDefaults.cruiseControl_safetyDistance_forward);
		...
		// emergencyBrakeDistanceBase =
		// scenarioLoader.getCarProperty(CarProperty.cruiseControl_emergencyBrakeDistance,
		// SimulationDefaults.cruiseControl_emergencyBrakeDistance);
	...
	public void update(float tpf)
	{
		...
		// this.isSnow = EffectCenter.getSnowingPercentage() > 20;
		// this.isRain = EffectCenter.getRainingPercentage() > 20;
		// if (isRain) {
		// this.emergencyContext = 1.2f;
		// this.safetyContext = 1.1f;
		// } else if (isSnow) {
		// this.emergencyContext = 1.8f;
		// this.safetyContext = 2.0f;
		// } else {
		// this.emergencyContext = 1.0f;
		// this.safetyContext = 1.0f;
		// }
		// framecounter = 0;
		// }
		// minLateralSafetyDistance = minForwardSafetyDistanceBase *
		// safetyContext;
		// minForwardSafetyDistance = minForwardSafetyDistanceBase *
		// safetyContext;
		// emergencyBrakeDistance = emergencyBrakeDistanceBase *
		// emergencyContext;
		// System.out.println("safety lateral = " + minLateralSafetyDistance);
		// System.out.println("safety forward = " + minForwardSafetyDistance);
		// System.out.println("emergency distance = " + emergencyBrakeDistance);
